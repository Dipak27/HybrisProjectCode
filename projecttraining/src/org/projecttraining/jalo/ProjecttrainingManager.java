...
/**
 * This is the extension manager of the Projecttraining extension.
 */
public class ProjecttrainingManager extends GeneratedProjecttrainingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ProjecttrainingManager.class);
	 ...
	 */
	public static ProjecttrainingManager getInstance()
	{
		return (ProjecttrainingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ProjecttrainingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProjecttrainingManager() // NOPMD 
	{
		LOG.debug("constructor of ProjecttrainingManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ProjecttrainingManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ProjecttrainingManager called, current tenant: {}", getTenant().getTenantID());
	}
