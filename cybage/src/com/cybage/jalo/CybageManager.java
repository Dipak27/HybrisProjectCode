...
/**
 * This is the extension manager of the Cybage extension.
 */
public class CybageManager extends GeneratedCybageManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CybageManager.class);
	 ...
	 */
	public static CybageManager getInstance()
	{
		return (CybageManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CybageConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CybageManager() // NOPMD 
	{
		LOG.debug("constructor of CybageManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CybageManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CybageManager called, current tenant: {}", getTenant().getTenantID());
	}
