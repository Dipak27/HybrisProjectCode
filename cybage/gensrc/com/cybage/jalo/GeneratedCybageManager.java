...
/**
 * Generated class for type <code>CybageManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedCybageManager extends Extension
{
	...
	public CybageEmployee createCybageEmployee(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( CybageConstants.TC.CYBAGEEMPLOYEE );
	...
	public CybageProject createCybageProject(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( CybageConstants.TC.CYBAGEPROJECT );
	...
	{
		return CybageConstants.EXTENSIONNAME;
	}
